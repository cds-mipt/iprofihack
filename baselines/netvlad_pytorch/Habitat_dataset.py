...
def get_whole_test_set(path_to_database_struct, onlyDB=False):
    return WholeDatasetFromStruct(path_to_database_struct,
                             input_transform=input_transform(),
                             onlyDB=onlyDB)
...
def parse_dbStruct(path_to_database_struct):
